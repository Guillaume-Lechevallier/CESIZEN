...
def get_dashboard_tracker():
    try:
        ...
        # Récupération des émotions de l'utilisateur
        cursor.execute("""
        ...
        # Récupération de la liste des émotions avec leurs couleurs
        cursor.execute("""
            SELECT emotion, emotion_texte, couleur
            FROM tracker_emotion_list
        """)
